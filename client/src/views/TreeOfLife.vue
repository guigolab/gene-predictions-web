...
export default {
  ...
  data() {
    return {
        ...
        data: Object
        // {
        //     branchset: [{name: 'cellular organism', 
        //         branchset:[{name:'Eukaryota', 
        //             branchset: [{name:'Mammalia', 
        //                 branchset: [{name: 'cellular organism', 
        //                     branchset:[{name:'Eukaryota', 
        //                         branchset: [{name:'Mammalia'}]}] },{name: 'cellular organism', 
        //         branchset:[{name:'Eukaryota', 
        //             branchset: [{name:'Mammalia', 
        //                 branchset: [{name: 'cellular organism', 
        //                     branchset:[{name:'Eukaryota', 
...
//   });
  ...
  methods: {
    createTree(){
        console.log(this.data.children[0].name)
        console.log("hola")
